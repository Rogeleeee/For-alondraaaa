...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para Alondra :\n\nDesde el primer momento supe que eras tú. Tu sonrisa, tu voz, tu forma de ser,tus cachetitos… todo en ti me hace sentir de una manera indescriptible.\n\nGracias por acompañarme en cada paso y perdon por lo que hemos pasado pero nuestro camino no acabara aqui.\n\nTe amo más de lo que las palabras pueden expresar y creeme que lo digo desde lo mas profundo de mi.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, tu chiflado Rogelio";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-11-15T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-08-02T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `nos conocimos desde: <b>${days}</b> días<br>` +
      `Nuestro supuesto aniversario: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
